...
1. Go to the [GitHub repository](https://github.com/your-repo-url) for this project. (Replace with actual URL if available.)
2. Click the **Fork** button in the top right corner of the page.
3. Choose your GitHub account as the destination for the fork.
4. Once forked, clone your copy to your local machine:
   ```bash
   git clone https://github.com/your-username/Monte-Carlo-Options-Universe.git
   ```
